"""Audit the uploaded h0-h5 archives for task cef21622, without changing miner data.

Run from the repository root with .venv/bin/python reports/cef21622/audit.py.
...
TASK_ID = "cef21622-627f-4171-bb83-53bfc44b4f91"
HOTKEYS = [
...
def main():
    ...
    joined = list(range(300, 500)) + list(range(800, 900))
    result = {
