"""Replay seven conjunctions and three all-HDR uploads for task f18ee409."""
import hashlib
...
TASK_ID = "f18ee409-bdb0-4e80-9818-e25f9f456f46"
...
def main():
    ...
    result = {
        ...
        "definitions": {
            ...
            "all_hdr_log_clean": "For h7–h9, log clean 8/34 is the Cas12a all-HDR intersection in the 34-seed candidate window, not the full-row no-cut-free set. Cas9 rows are then selected to return HDR on those eight seeds.",
        },
        "hotkeys": {},
    }
    for i in range(10):
        ...
        if is_conjunction:
            ...
            assert "15 seeds (shared window, loop 1 of 7) | cut 200 seeds (narrow) | k=8" in candidate_lines[0]
        else:
        ...
        if is_conjunction:
            ...
            assert logged == (80, len(set(ca_hdr) & set(candidates)), 34)
