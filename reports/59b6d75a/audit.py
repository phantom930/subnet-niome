"""Audit the uploaded h0-h6 archives for task 59b6d75a, without changing miner data.

Run from the repository root with .venv/bin/python reports/59b6d75a/audit.py.
...
TASK_ID = "59b6d75a-824b-4021-bd7a-3360b43ef0e4"
HOTKEYS = [
...
def main():
    ...
    joined = list(range(100, 300)) + list(range(900, 1000))
    ...
    result = {
        ...
        "definitions": {
            ...
            "cas12a_clean_seeds": "All submitted Cas12a rows cut over 100-999 (100 rows for conjunction; 74 for h1's fallback).",
            ...
            "candidate_window": "Planned 150-seed slice reconstructed from logged joined space and offsets 0/50/100/150/200/250/25. h1 submitted an ordinary fallback instead.",
        },
        "hotkeys": {},
    }
    for i, hk in enumerate(HOTKEYS):
        ...
        rec = {
            ...
            "construction": "ordinary_hdr_fallback" if i == 1 else "conjunction",
            ...
            "candidate_window_applies_to_submission": i != 1,
