"""Replay the ten uploaded submissions for task 14dcd43f against every seed 100–999."""
import hashlib
...
TASK_ID = "14dcd43f-6f42-4d7b-8349-475662dd7a85"
...
def main():
    ...
    predicted = list(range(200, 400)) + list(range(900, 1000))
    ...
    result = {
        ...
        "predicted_windows": [200, 300, 900], "predicted_joined": predicted,
        "complement_joined": complement, "plan_generated_at": "2026-09-18T19:17:11.999319+00:00",
    ...
    for i in range(10):
        ...
        assert window_lines and all("200-399,900-999" in e and "2026-09-18T19:17" in e for e in window_lines)
        ...
        assert logged == (8, 8, 80, len(ca_clean), 900)
